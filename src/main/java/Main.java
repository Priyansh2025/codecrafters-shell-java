...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            // Parse command and arguments (handles single quotes, redirection, and
            // pipelines)
                    ...
                    if (allFound) {
                        try {
                            ...
                            if (parsed.runInBackground) {
                                ...
                                jobsList.add(
                                        new Job(jobNum, lastProcess.pid(), parsed.commandStr, "Running", lastProcess));
                            } else {
                                ...
                                if (builtins.contains(scmd.args[0])) {
                                    ...
                                    if (i == k - 1) {
                                        if (scmd.redirectFile != null) {
                                            ...
                                            finalOut = new java.io.PrintStream(
                                                    new java.io.FileOutputStream(outputFile, scmd.appendOut));
                                        } else {
                                            finalOut = safeOut;
                                        }
                                    } else {
                                    ...
                                    if (scmd.redirectErrFile != null) {
                                        ...
                                        finalErr = new java.io.PrintStream(
                                                new java.io.FileOutputStream(errFile, scmd.appendErr));
                                    } else {
                                        finalErr = safeErr;
                                    }
    ...
    private static boolean executeBuiltin(String command, String[] parts, java.io.PrintStream out,
            java.io.PrintStream err, boolean isPipelineStage) {
    ...
    private static class SingleCommand {
        ...
        SingleCommand(String[] args, String redirectFile, boolean appendOut, String redirectErrFile,
                boolean appendErr) {
            this.args = args;
